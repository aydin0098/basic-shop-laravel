                ...
                <div class="col-lg-12 col-12 ">
                    <form wire:submit.prevent="submit(Object.fromEntries(new FormData($event.target)))">
                        <div class="form-group">
                            <label for="t-text" class="form-label">نام دسته</label>
                            <input wire:model="name" id="t-text" type="text" name="name" placeholder="دسته جدید ..." class="form-control">
                            @error('name')
                        ...
                        <div class="form-group mt-4">
                            <label for="t-text" class="form-label">دسته والد :</label>
                            <select wire:model="category_id"
                                name="category_id" class="form-select" aria-label="Default select example" wire:ignore>
                                <option value="">--</option>
