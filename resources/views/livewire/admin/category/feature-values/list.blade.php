    ...
    <div class="statbox widget box box-shadow">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="table-responsive">
                        ...
                        <tr>
                            <td>
                                <div class="media">
                                    <div class="media-body align-self-center">
                                        <h6 class="mb-0">{{$loop->iteration + $featureValues->firstItem()-1}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <div class="action-btns">
                                    ...
                                    <a  wire:confirm="آیا رکورد حذف شود ؟؟" wire:click="delete({{$value['id']}})"
                ...
                {{$featureValues->links('layouts.admin.paginate')}}
            </div>
