                ...
                <div class="col-lg-12 col-12 ">
                    <form wire:submit.prevent="submit(Object.fromEntries(new FormData($event.target)))">
                        <div class="form-group">
                            <label for="t-text" class="form-label">نام مقدار</label>
                            <input wire:model="value" id="t-text" type="text" name="value" placeholder="مقدار جدید ..." class="form-control">
                            @error('value')
